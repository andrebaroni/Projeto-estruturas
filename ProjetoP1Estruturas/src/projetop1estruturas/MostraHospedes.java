 ...
 * @author André Baroni
 */
public class MostraHospedes extends javax.swing.JFrame {

    /**
     * Creates new form MostraHospedes
     */
    public MostraHospedes() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostraHospedes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostraHospedes().setVisible(true);
            }
        });
    }
